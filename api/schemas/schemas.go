...
import (
	...
	// "github.com/chromedp/cdproto/network" // No longer needed as we define Cookie locally.
)
...
type SessionContext interface {
	...
	// FIX: Updated interaction methods to include context.Context to align with humanoid.Controller.
	...
	// FIX: Updated to include context.Context.
