...
func SetupObservability(t *testing.T) {
    ...
    // Check if already initialized to avoid overwriting during parallel tests if necessary,

    // although typically SetLogger handles concurrency if implemented correctly.
